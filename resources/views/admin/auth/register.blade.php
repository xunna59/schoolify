...
<body>
                        ...
                        <div class="login-right-wrap">
                            ...
                            <form action="{{ route('admin.create') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control pass-confirm" id="password_confirmation"
                                ...
                                <div class=" dont-have">Already Registered? <a
                                        href="{{ route('admin.login') }}">Login</a></div>
    ...
    <script src="../assets/js/jquery-3.7.1.min.js" type="be9ad116456316ccb5b3696c-text/javascript"></script>
    <script src="../assets/js/bootstrap.bundle.min.js" type="be9ad116456316ccb5b3696c-text/javascript"></script>

    <script src="../assets/js/feather.min.js" type="be9ad116456316ccb5b3696c-text/javascript"></script>

    <script src="../assets/js/script.js" type="be9ad116456316ccb5b3696c-text/javascript"></script>
    <script src="../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="be9ad116456316ccb5b3696c-|49" defer></script>
</body>
